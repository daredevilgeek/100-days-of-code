...
**Today's Progress**: Worked some more on the blog app (to add new blogs with a form) - and then had a wee look at my parked weather app, able to make a quick fix.

## R2D55: Mar 5 2018

**Today's Progress**: Building RESTful routes with the bootcamp, making a small blog app.

## R2D52: Mar 1 2018

**Today's Progress**: Some good work on the bootcamp again tonight with new routes

## R2D51: Feb 28 2018

**Today's Progress**: Not great at logging this - but back on the bootcamp bandwagon.
...
**Today's Progress**: A couple of hours playing CodeWars.

## R2D36: Feb 11 2018

**Today's Progress**: Learning about APIs in the boot camp

## R2D35: Feb 8 2018

**Today's Progress**: A couple of hours playing CodeWars, even levelled up! Trying to learn tactics other than for/if.

## R2D34: Feb 7 2018

**Today's Progress**: Home late, so spent some time playing CodeWars to brush up on my problem solving skills.

## R2D33: Feb 6 2018

**Today's Progress**: Got disciplined! Used Pomodoro to keep me on track. Feeling good about what I achieved today.

## R2D32: Feb 5 2018

**Today's Progress**: Made a wee express app for practice - learning that algorithm solutions are probably more simple than I think they are.

## R2D30-31: Feb 3-4 2018

**Today's Progress**: Some rec time using SoloLearn to check JavaScript skills, and starting to get into using express.
...
**Today's Progress**: Finished the Paper.js work (Patatap clone) and moved into learning about the back end.
...
**Today's Progress**: Did some Temporal Difference tutorials but feel like it's going in one ear and out the other!
